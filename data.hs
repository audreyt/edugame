...
actions =
    ...
    , Action 2 "面談" 0 "✆ 一名學生。"
        "每個人的生命，都是說不完的故事。"
    , Action 3 "回應需求" 0 "本回合所出的教學卡，不需擲親和骰。"
        "說不出口的才算數。"
    , Action 4 "弱勢生名額" 0 "放入一張新的學生卡，面向下。"
        "給學習一個機會。"
    , Action 5 "試教" 0 "取回一張由自已所出，最頂端的教學卡。"
        "要瞭解現場教學，只有去現場教學。"
    ...
    , Action 8 "記取經驗" 1 "取回一張棄牌堆中的教育卡。"
        "創造始於摹仿。"
    , Action 9 "轉學" 2 "立即結算一張學生卡，\n再放入一名新的學生，面向下。"
        "至少我們曾經相聚過。"
    , Action 10 "典範效應" 2 "將一張場上的技藝卡改為環境卡。"
        "臨而後可觀。"
   ]

students =
    [ Student 1 "沈括" [A,K,R,V] 1 9 [a,c,m,n,p,s] []
        "博學善文，於天文、方志、律曆、音樂、\n醫藥、卜算無所不通，皆有所論著。"
    ...
    , Student 6 "巴哈" [A,R] 1 5 [a,m] [e,m,p]
        "我非勤勉不可，誰能像我一樣的勤勉，\n就能有同樣的成就。"
    , Student 7 "李清照" [A,R] 3 6 [a,c] [a,m,n,p]
        "此情無計可消除，才下眉頭，卻上心頭。"
    , Student 8 "法布爾" [K,V] 1 5 [n,s] [a,m,n,s]
        "要遠離主流的道路，才能有新的發現。"
    , Student 9 "阿基米德" [K,V] 3 6 [m,n] [a,e,n,s]
        "不要碰我的圖！"
    , Student 10 "李白" [R,V] 1 5 [a,c] [a,n,p,s]
        "鐘鼓饌玉何足貴，但願長醉不願醒。"
    , Student 11 "達爾文" [R,V] 3 6 [e,n] [e,m,p]
        "和友情相比，名聲、榮譽、快樂和財富，\n都是塵土。"
    , Student 12 "張衡" [A,K] 1 5 [m,n] [a,m,p,s]
        "願竭力以守義兮，雖貧窮而不改。"
    , Student 13 "鄧肯" [A,K] 3 6 [a,p] [a,m,s]
        "自由的身體蘊藏最高的智慧。"
    , Student 14 "艾雪" [A,V] 1 5 [a,m] [e,m,n,s]
        "我的工作是遊戲：非常認真的遊戲。"
    , Student 15 "屈原" [A,V] 3 6 [c,s] [m,n,p,s]
        "國無人莫我知兮，又何懷乎故都？\n既莫足爲美政兮，吾將從彭咸之所居。"
    , Student 16 "紀政" [K,R] 1 5 [p,s] [c,e,m,s]
        "如果失去了勇氣，一切也都完了。"
    , Student 17 "居禮夫人" [K,R] 3 6 [n] [p,s]
        "生命中的一切不足以恐懼，只足以瞭解。"
    , Student 18 "愛迪生" [K,R,V] 3 7 [a,n,s] [a,p,s]
        "我的發明都不是湊巧。\n我一次又一次實驗，直到它化為現實。"
    , Student 19 "薩提爾" [A,K,R] 3 7 [e,n,s] [a,c,n]
        "我要成為幫小孩觀察大人的偵探。"
    , Student 20 "愛因斯坦" [A,R,V] 3 7 [m,n,s] [m,p,s]
        "我並不是很聰明，\n只是和問題相處得久一點。"
    , Student 21 "法拉第" [A,K,V] 3 7 [a,n,p] [m,n,s]
        "插上了想像的翅膀，科學就能得勝。"
    , Student 22 "克里希那穆提" [] 1 4 [s] []
        "年幼，無心向學，體弱而好幻。\n其師鄙之，常施毒打。父亦如是。\n然克氏處之泰然，寵辱不驚。"
    , Student 23 "海倫凱勒" [K,R,Anti A,Anti V] 3 10 [e,s] [e,s]
        "離開了井後，我渴望學習：\n因為每樣東西都有一個名字。"
    , Student 24 "周大觀" [A,R,V,Anti K] 3 10 [a,c,s] [p]
        "我還有一隻腳。"
    , Student 25 "湯姆克魯斯" [A,K,V,Anti R] 3 10 [a,p,s] [e,m,s]
        "我常將字寫顛倒，閱讀又如此困難。\n我覺得大家都把我當笨蛋，羞恥極了。"
    , Student 26 "胡一舟" [A,K,Anti R,Anti V] 3 10 [a] [c,m,s]
        "上帝無情地關上心智之窗，\n卻又慷慨地大開音樂之門。"
   ]

lessons =
    [ Lesson 1 "放牛吃草" [K] 1 100 [a,p] []
        "就自由活動吧。"
    , Lesson 2 "放牛吃草" [A] 1 100 [c,e,s] []
        "先去辦點事。"
    , Lesson 3 "放牛吃草" [R] 1 100 [m,n] []
        "安靜自習！"
    ...
    , Lesson 18 "實驗仿作" [A,K] 3 0 [n,s] []
        "雖然早已預知結果，實驗還是令人驚奇。"
    , Lesson 19 "趣味數學" [A,K,R] 0 0 [m] [i]
        "由趣味的數學，進入數學的趣味。"
    , Lesson 20 "趣味科學" [A,K,R] 0 0 [n] [i]
        "偶而裝傻好像也不錯。"
    ...
    , Lesson 23 "歌唱入門" [A] 1 1 [a,c,e] []
        "欣賞自己的聲音。"
    , Lesson 24 "精研武術" [K,V] 4 100 [a,p] []
        "不爭不鬥，止戈為武。"
    , Lesson 25 "精研舞蹈" [A,K] 4 100 [a,p] []
        "台上一分鐘，台下十年功。"
    , Lesson 26 "精研歌唱" [A] 4 100 [a,c,e] []
        "歌唱的技巧，聲音的表情。"
    , Lesson 27 "指定閱讀" [R] 4 100 [c,e,s] []
        "問題是他肯不肯翻開第一頁？"
    , Lesson 28 "指定閱讀" [R] 4 100 [a,m,n,p] []
        "有時教師比學生更了解他的需求。"
    ...
    , Lesson 34 "自學指導" [A,K,R] 4 0 [c,e,s] [l]
        "知識是用拿的，不是用給的。"
    , Lesson 35 "獨立研究" [] 7 100 [] [l]
        "最好的老師，讓學生離開他之後，\n也學得好。"
    , Lesson 36 "個別輔導" [A] 1 3 [] [l]
        "許多人的教育之路，由家教和課輔開始。"
    , Lesson 37 "個別輔導" [A] 1 3 [] [l]
        "最有效的診斷，是一對一。"
    , Lesson 38 "小階梯教學" [A,V] 100 3 [] [u]
        "知識若切太細，雖然可以跟隨，\n卻會失去意義。"
    , Lesson 39 "小階梯教學" [K,V] 100 3 [] [u]
        "有人需要一步一步慢慢來。"
    , Lesson 40 "小階梯教學" [R,V] 100 3 [] [u]
        "千里之行，始於足下。"
    ...
    , Lesson 49 "寫作工坊" [A,R] 2 2 [a,c] [u]
        "創作是為了交流。"
    , Lesson 50 "科學史" [R] 3 3 [m,n,s] []
        "掌握原始問題，就掌握了知識的大半。"
    , Lesson 51 "語文史" [R] 3 3 [c,e,s] []
        "博古而能通今。"
    , Lesson 52 "藝術史" [R] 3 3 [a,s] []
        "簡潔與合一，是美的泉源。"
    , Lesson 53 "華德福教學" [K,V] 3 3 [a,n,p] []
        "透過身體，將意志帶進思考。"
    , Lesson 54 "蒙特梭利教學" [K,R] 3 3 [a,m,n] []
        "不必主動去教，只需觀察、引導、解惑。"
    , Lesson 55 "蘇格拉底教學" [A,K] 3 3 [e,m,s] []
        "我知我無知，所以就去問。"
    , Lesson 56 "進階發現教學" [A,K,R,V] 4 2 [m,n,s] [u]
        "知識無法傳授，只能重新發生。"
    , Lesson 57 "進階討論教學" [A,K,R,V] 4 2 [c,m,s] [u]
        "萬法歸宗。"
    , Lesson 58 "經典研讀" [R] 4 4 [c] []
        "看解說，不如讀原典。"
    , Lesson 59 "會話教學" [A] 4 4 [e] []
        "Here we speak \nEnglish only."
    , Lesson 60 "體能集訓" [K] 4 4 [p] []
        "苦練、苦練、再苦練。"
    , Lesson 61 "啟蒙導師遊戲" [A,K,R,V] 4 4 [s] [i]
        "請支持自創遊戲！"
   ]
...
skills =
    [ Skill 1 "以火點火" "教學額外具有 ♥ 能力。"
        "授己所愛，愛己所授。"
    , Skill 2 "以心傳心" "即使學習風格不合，教學仍視為成功。"
        "佛陀拈花，迦葉微笑。"
    , Skill 3 "同理" "教學額外具有 ✙ 能力。"
        "向童年的自己學習。"
    , Skill 4 "巧思" "教學卡皆獲得 +1 力道。"
        "尺有所短，寸有所長。"
    , Skill 5 "圖象" "教學可額外具有或失去視覺風格。"
        "圖象比文字更鮮明。"
    , Skill 6 "音符" "教學可額外具有或失去聽覺風格。"
        "共鳴，直接的共鳴。"
    , Skill 7 "文字" "教學可額外具有或失去閱讀風格。"
        "凡能寫的，都能寫清楚。"
    , Skill 8 "實作" "教學可額外具有或失去操作風格。"
        "學以致用，從做中學。"
    , Skill 9 "搞笑" "無興趣時，蒙昧值取左。"
        "他們喜歡的，是學問本身？"
